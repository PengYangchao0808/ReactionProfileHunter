...
usage() {
    cat <<'EOF'
Usage:
  bash benchmark/run_benchmark.sh --rx-id 1
  bash benchmark/run_benchmark.sh --rx-id 1,3,8
  bash benchmark/run_benchmark.sh --all
  bash benchmark/run_benchmark.sh --rx-id 1 --protocols ext,lite
  bash benchmark/run_benchmark.sh --rx-id 1 --reaction-type [4+3]_default
