"""S4 high-precision QC stage (backward-compat alias for RefinementEngine).

Phase 3+: ``HighLevelEngine`` is just a thin alias layer over
...
class HighLevelEngine(RefinementEngine):
    """Backward-compat alias for S4 refinement execution."""
    ...
    def __init__(
        ...
        if isinstance(profile, FidelityProfile):
            ...
            resolved_profile = FidelityProfile.from_config(config, "S4")
