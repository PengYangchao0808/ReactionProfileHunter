...
python ci/check_imports.py /tmp 2>&1 | head -20
echo $?  # Expected: 1
```
...
**Solution:** Add to `ALLOWED_EXCEPTIONS` list in `ci/check_imports.py`:
...
- [IMPORT_GUIDELINES.md](./IMPORT_GUIDELINES.md) - Detailed import style guidelines
