...
class TestStepWiseRefactor:
    ...
    def test_step1_to_step2(self, hunter, test_smiles, tmp_path):
        ...
        assert result.forming_bonds is None, "形成键信息不应来自 S2"
        ...
        print(f"  Forming bonds (expected None in S2): {result.forming_bonds}")
    ...
    def test_full_pipeline_refactored(self, hunter, test_smiles, tmp_path):
        ...
        assert result.forming_bonds is not None, "形成键信息缺失 (应来自 S1/S3 推导)"
