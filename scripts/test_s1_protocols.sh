#!/usr/bin/env bash
# ============================================================================
# test_s1_protocols.sh — S1 协议 (ext / full / lite / zero) 逐轮测试
# ============================================================================
# 用法:
#   bash scripts/test_s1_protocols.sh          # 依次跑 ext → full → lite → zero
#   bash scripts/test_s1_protocols.sh lite     # 只跑指定协议
#   bash scripts/test_s1_protocols.sh ext zero # 跑 ext 和 zero
#
# 前置条件:
